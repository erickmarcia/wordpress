<?php
/**
 * Created by Software Soluciones.
 * User: emarcia
 * Date: 06/05/19
 */

function dcgw_filters_by_cities_method() {
    if ( ! class_exists( 'Dcgw_Filters_By_Cities_Method' ) ) {

        class Dcgw_Filters_By_Cities_Method extends WC_Shipping_Method
        {
            ...
            public function __construct($instance_id = 0)
            {
                ...
                $this->method_title       = __( 'Shipping filter By Cities', 'departamentos-y-ciudades-de-nicaragua-para-woocommerce' );
                $this->method_description = __( 'Allows adding rules by city', 'departamentos-y-ciudades-de-nicaragua-para-woocommerce' );
            ...
            public function showCitiesRegions()
            {
                ...
                foreach ($zones as $zone){
                    if (strpos($zone->code, ':') !== false){
                        ...
                        $states = WC_States_Places_Nicaragua::get_places( $place[0] );
